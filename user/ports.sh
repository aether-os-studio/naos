...
sudo chroot "$SYSROOT/" /bin/bash --login -c "apk add musl-dev seatd gcompat gzip xz make file tar pciutils tzdata nano lua5.1 gcc binutils libdrm-dev libdrm-tests bind-tools curl sysbench evtest"
