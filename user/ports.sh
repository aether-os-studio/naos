...
sudo chroot "$SYSROOT/" /bin/bash --login -c "apk add sway swaybg xwayland xdg-desktop-portal xdg-desktop-portal-wlr xdg-desktop-portal-gtk ttf-dejavu waybar at-spi2-core"
sudo chroot "$SYSROOT/" /bin/bash --login -c "apk add weston-shell-desktop weston-terminal"
