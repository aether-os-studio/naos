...
static bool loongarch64_serial_can_read(serial_driver_t *driver);
static bool loongarch64_serial_read(serial_driver_t *driver, char *ch);
static void loongarch64_serial_write(serial_driver_t *driver, char ch);

static serial_driver_t loongarch64_serial_driver = {
    .name = "loongarch64-16550",
    .can_read = loongarch64_serial_can_read,
    .read = loongarch64_serial_read,
    .write = loongarch64_serial_write,
};
...
int init_serial() {
    ...
    return uart0 ? serial_register_driver(&loongarch64_serial_driver) : -1;
}
...
static bool loongarch64_serial_read(serial_driver_t *driver, char *ch) {
    if (!loongarch64_serial_can_read(driver))
        return false;
