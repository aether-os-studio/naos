...
void syscall_handlers_init() {
    ...
    // (syscall_handle_t)sys_lookup_dcookie; syscall_handlers[SYS_EPOLL_CTL_OLD]
    // = (syscall_handle_t)sys_epoll_ctl_old;
    // syscall_handlers[SYS_EPOLL_WAIT_OLD] =
    ...
    // syscall_handlers[SYS_TIMER_SETTIME] =
    // (syscall_handle_t)sys_timer_settime; syscall_handlers[SYS_TIMER_GETTIME]
    ...
    // (syscall_handle_t)sys_ioprio_get; syscall_handlers[SYS_INOTIFY_ADD_WATCH]
    ...
    // (syscall_handle_t)sys_move_pages; syscall_handlers[SYS_UTIMENSAT] =
    // (syscall_handle_t)sys_utimensat;
    ...
    // (syscall_handle_t)sys_io_pgetevents; syscall_handlers[SYS_RSEQ] =
    // (syscall_handle_t)sys_rseq; syscall_handlers[SYS_PIDFD_SEND_SIGNAL] =
    ...
    // (syscall_handle_t)sys_move_mount; syscall_handlers[SYS_FSOPEN] =
    // (syscall_handle_t)sys_fsopen; syscall_handlers[SYS_FSCONFIG] =
    // (syscall_handle_t)sys_fsconfig; syscall_handlers[SYS_FSMOUNT] =
    // (syscall_handle_t)sys_fsmount; syscall_handlers[SYS_FSPICK] =
    // (syscall_handle_t)sys_fspick; syscall_handlers[SYS_PIDFD_OPEN] =
    // (syscall_handle_t)sys_pidfd_open; syscall_handlers[SYS_CLONE3] =
    // (syscall_handle_t)sys_clone3;
