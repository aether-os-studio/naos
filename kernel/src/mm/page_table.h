...
#define PAGE_CALC_PAGE_TABLE_SIZE(level) ((uint64_t)1 << (ARCH_PT_OFFSET_BASE + (ARCH_MAX_PT_LEVEL - (level)) * ARCH_PT_OFFSET_PER_LEVEL))
#define PAGE_CALC_PAGE_TABLE_MASK(level) (PAGE_CALC_PAGE_TABLE_SIZE(level) - (uint64_t)1)
#define PAGE_CALC_PAGE_TABLE_INDEX(vaddr, level) (((vaddr) >> (ARCH_PT_OFFSET_BASE + (ARCH_MAX_PT_LEVEL - (level)) * ARCH_PT_OFFSET_PER_LEVEL)) & (((uint64_t)1 << ARCH_PT_OFFSET_PER_LEVEL) - 1))
