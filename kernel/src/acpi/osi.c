...
static struct registered_interface *
find_interface_unlocked(const uacpi_char *name) {
...
static struct registered_interface *
find_host_interface_unlocked(uacpi_host_interface type) {
    struct registered_interface *interface = registered_interfaces;
...
uacpi_status
uacpi_set_interface_query_handler(uacpi_interface_handler handler) {
    uacpi_status ret;
