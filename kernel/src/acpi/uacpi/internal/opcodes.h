...
#define UACPI_METHOD_CALL_OPCODE(nargs)                                        \
    UACPI_OP(InternalOpMethodCall##nargs##Args, 0xF7 + nargs,                  \
             UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,          \
             {                                                                 \
                 UACPI_PARSE_OP_LOAD_INLINE_IMM,                               \
                 1,                                                            \
                 nargs,                                                        \
...
#define UACPI_UNRESOLVED_NAME_STRING_OP(character, code)                       \
    UACPI_OP(UACPI_InternalOpUnresolvedNameString_##character, code,           \
             UACPI_OP_PROPERTY_SIMPLE_NAME | UACPI_OP_PROPERTY_SUPERNAME |     \
...
#define UACPI_BUILD_LOCAL_OR_ARG_OP(prefix, base, offset)                      \
    UACPI_OP(prefix##offset##Op, base + offset,                                \
             UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TERM_ARG |        \
...
#define UACPI_BUILD_PACKAGE_OP(name, code, jmp_off, ...)                       \
    UACPI_OP(name##Op, code, UACPI_OP_PROPERTY_TERM_ARG,                       \
             {                                                                 \
                 UACPI_PARSE_OP_TRACKED_PKGLEN,                                \
                 ##__VA_ARGS__,                                                \
                 UACPI_PARSE_OP_IF_HAS_DATA,                                   \
...
#define UACPI_BUILD_BINARY_MATH_OP(prefix, code)                               \
    UACPI_OP(prefix##Op, code, UACPI_OP_PROPERTY_TERM_ARG,                     \
             {                                                                 \
                 UACPI_PARSE_OP_OPERAND,                                       \
                 UACPI_PARSE_OP_OPERAND,                                       \
                 UACPI_PARSE_OP_TARGET,                                        \
...
#define UACPI_BUILD_UNARY_MATH_OP(type, code)                                  \
    UACPI_OP(type##Op, code, UACPI_OP_PROPERTY_TERM_ARG,                       \
             {                                                                 \
                 UACPI_PARSE_OP_OPERAND,                                       \
                 UACPI_PARSE_OP_TARGET,                                        \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                            \
...
#define UACPI_INTEGER_LITERAL_OP(type, code, bytes)                            \
    UACPI_OP(type##Prefix, code, UACPI_OP_PROPERTY_TERM_ARG,                   \
             {                                                                 \
                 UACPI_PARSE_OP_LOAD_IMM_AS_OBJECT,                            \
                 bytes,                                                        \
                 UACPI_PARSE_OP_OBJECT_TRANSFER_TO_PREV,                       \
...
#define UACPI_BUILD_TO_OP(kind, code, dst_type)                                \
    UACPI_OP(To##kind##Op, code, UACPI_OP_PROPERTY_TERM_ARG,                   \
             {                                                                 \
                 UACPI_PARSE_OP_COMPUTATIONAL_DATA,                            \
                 UACPI_PARSE_OP_TARGET,                                        \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                            \
...
#define UACPI_ENUMERATE_OPCODES                                                                                                                                                                                                                                                                                              \
    UACPI_OP(ZeroOp, 0x00,                                                                                                                                                                                                                                                                                                   \
             UACPI_OP_PROPERTY_TARGET | UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                          \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_LOAD_INLINE_IMM_AS_OBJECT,                                                                                                                                                                                                                                                                   \
                 0x00,                                                                                                                                                                                                                                                                                                       \
                 0x00,                                                                                                                                                                                                                                                                                                       \
    ...
    UACPI_OP(OneOp, 0x01, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                        \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_LOAD_INLINE_IMM_AS_OBJECT,                                                                                                                                                                                                                                                                   \
                 0x01,                                                                                                                                                                                                                                                                                                       \
                 0x00,                                                                                                                                                                                                                                                                                                       \
    ...
    UACPI_OP(StringPrefix, 0x0D, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                 \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                                                                                                                                                                                                                          \
                 UACPI_OBJECT_STRING,                                                                                                                                                                                                                                                                                        \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                                                                                                                                              \
    ...
    UACPI_OP(BufferOp, 0x11, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                     \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TRACKED_PKGLEN,                                                                                                                                                                                                                                                                              \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
                 UACPI_PARSE_OP_RECORD_AML_PC,                                                                                                                                                                                                                                                                               \
    ...
    UACPI_BUILD_PACKAGE_OP(Package, 0x12, 3, UACPI_PARSE_OP_LOAD_IMM, 1)                                                                                                                                                                                                                                                     \
    UACPI_BUILD_PACKAGE_OP(VarPackage, 0x13, 2, UACPI_PARSE_OP_OPERAND)                                                                                                                                                                                                                                                      \
    UACPI_OP(MethodOp, 0x14, 0,                                                                                                                                                                                                                                                                                              \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TRACKED_PKGLEN,                                                                                                                                                                                                                                                                              \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,                                                                                                                                                                                                                                                           \
                 UACPI_PARSE_OP_LOAD_IMM,                                                                                                                                                                                                                                                                                    \
    ...
    UACPI_OP(StoreOp, 0x70, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                      \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG,                                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_SUPERNAME,                                                                                                                                                                                                                                                                                   \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                                                                                                                                              \
    ...
    UACPI_OP(RefOfOp, 0x71, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                      \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_SUPERNAME,                                                                                                                                                                                                                                                                                   \
                 UACPI_PARSE_OP_OBJECT_ALLOC,                                                                                                                                                                                                                                                                                \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                                                                                                                                              \
    ...
    UACPI_OP(ConcatOp, 0x73, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                     \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_COMPUTATIONAL_DATA,                                                                                                                                                                                                                                                                          \
                 UACPI_PARSE_OP_COMPUTATIONAL_DATA,                                                                                                                                                                                                                                                                          \
                 UACPI_PARSE_OP_TARGET,                                                                                                                                                                                                                                                                                      \
    ...
    UACPI_OP(DivideOp, 0x78, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                     \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
                 UACPI_PARSE_OP_TARGET,                                                                                                                                                                                                                                                                                      \
    ...
    UACPI_OP(DerefOfOp, 0x83, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                    \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_OBJECT_ALLOC,                                                                                                                                                                                                                                                                                \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                                                                                                                                              \
    ...
    UACPI_OP(ConcatResOp, 0x84, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                  \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_TYPECHECK,                                                                                                                                                                                                                                                                                   \
                 UACPI_OBJECT_BUFFER,                                                                                                                                                                                                                                                                                        \
    ...
    UACPI_OP(NotifyOp, 0x86, 0,                                                                                                                                                                                                                                                                                              \
             {                                                                                                                                                                                                                                                                                                               \
                 /* This is technically wrong according to spec but I was */ /* unable to find any examples of anything else after    */ /* inspecting about 500 AML dumps. Spec says this is a   */ /* SuperName that must evaluate to Device/ThermalZone or */ /* Processor, just ignore for now.                       */ \
                 UACPI_PARSE_OP_EXISTING_NAMESTRING_OR_NULL_IF_LOAD,                                                                                                                                                                                                                                                         \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
                 UACPI_PARSE_OP_SKIP_WITH_WARN_IF_NULL,                                                                                                                                                                                                                                                                      \
                 0,                                                                                                                                                                                                                                                                                                          \
    ...
    UACPI_OP(SizeOfOp, 0x87, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                     \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_SUPERNAME,                                                                                                                                                                                                                                                                                   \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                                                                                                                                                                                                                          \
                 UACPI_OBJECT_INTEGER,                                                                                                                                                                                                                                                                                       \
    ...
    UACPI_OP(IndexOp, 0x88,                                                                                                                                                                                                                                                                                                  \
             UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_SUPERNAME |                                                                                                                                                                                                                                                      \
                 UACPI_OP_PROPERTY_SIMPLE_NAME,                                                                                                                                                                                                                                                                              \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
    ...
    UACPI_OP(MatchOp, 0x89, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                      \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_TYPECHECK,                                                                                                                                                                                                                                                                                   \
                 UACPI_OBJECT_PACKAGE,                                                                                                                                                                                                                                                                                       \
    ...
    UACPI_OP(ObjectTypeOp, 0x8E, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                 \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG_OR_NAMED_OBJECT,                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                                                                                                                                                                                                                          \
                 UACPI_OBJECT_INTEGER,                                                                                                                                                                                                                                                                                       \
    ...
    UACPI_OP(LnotOp, 0x92, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                       \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
                 UACPI_PARSE_OP_OBJECT_ALLOC,                                                                                                                                                                                                                                                                                \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                                                                                                                                              \
    ...
    UACPI_OP(ToStringOp, 0x9C, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                   \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_TYPECHECK,                                                                                                                                                                                                                                                                                   \
                 UACPI_OBJECT_BUFFER,                                                                                                                                                                                                                                                                                        \
    ...
    UACPI_OP(CopyObjectOp, 0x9D, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                 \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG,                                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_OBJECT_COPY_TO_PREV,                                                                                                                                                                                                                                                                         \
                 UACPI_PARSE_OP_SIMPLE_NAME,                                                                                                                                                                                                                                                                                 \
    ...
    UACPI_OP(MidOp, 0x9E, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                        \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
    ...
    UACPI_OP(ContinueOp, 0x9F, 0,                                                                                                                                                                                                                                                                                            \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                                                                                                                                              \
             })                                                                                                                                                                                                                                                                                                              \
    UACPI_OP(IfOp, 0xA0, 0,                                                                                                                                                                                                                                                                                                  \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TRACKED_PKGLEN,                                                                                                                                                                                                                                                                              \
                 UACPI_PARSE_OP_OPERAND,                                                                                                                                                                                                                                                                                     \
                 UACPI_PARSE_OP_IF_LAST_NULL,                                                                                                                                                                                                                                                                                \
    ...
    UACPI_OP(NoopOp, 0xA3, 0,                                                                                                                                                                                                                                                                                                \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_END,                                                                                                                                                                                                                                                                                         \
             })                                                                                                                                                                                                                                                                                                              \
    UACPI_OP(ReturnOp, 0xA4, 0,                                                                                                                                                                                                                                                                                              \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                                                                                                                                                                                                                                    \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                                                                                                                                              \
             })                                                                                                                                                                                                                                                                                                              \
    UACPI_OP(BreakOp, 0xA5, 0,                                                                                                                                                                                                                                                                                               \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                                                                                                                                              \
             })                                                                                                                                                                                                                                                                                                              \
    ...
    UACPI_OP(InternalOpReadFieldAsBuffer, 0xF4,                                                                                                                                                                                                                                                                              \
             UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                                                                                                                                                                                                                                        \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                                                                                                                                                                                                                          \
                 UACPI_OBJECT_BUFFER,                                                                                                                                                                                                                                                                                        \
    ...
    UACPI_OP(InternalOpReadFieldAsInteger, 0xF5,                                                                                                                                                                                                                                                                             \
             UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                                                                                                                                                                                                                                        \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                                                                                                                                                                                                                          \
                 UACPI_OBJECT_INTEGER,                                                                                                                                                                                                                                                                                       \
    ...
    UACPI_OP(InternalOpNamedObject, 0xF6,                                                                                                                                                                                                                                                                                    \
             UACPI_OP_PROPERTY_SIMPLE_NAME | UACPI_OP_PROPERTY_SUPERNAME |                                                                                                                                                                                                                                                   \
                 UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                                                                                                                                                                                                                                    \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_EMPTY_OBJECT_ALLOC,                                                                                                                                                                                                                                                                          \
    ...
    UACPI_OP(OnesOp, 0xFF, UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                                                                                                                                                                       \
             {                                                                                                                                                                                                                                                                                                               \
                 UACPI_PARSE_OP_LOAD_INLINE_IMM_AS_OBJECT,                                                                                                                                                                                                                                                                   \
                 0xFF,                                                                                                                                                                                                                                                                                                       \
                 0xFF,                                                                                                                                                                                                                                                                                                       \
...
#define UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(name, code, type, ...)               \
    UACPI_OP(name##Op, UACPI_EXT_OP(code), 0,                                  \
             {                                                                 \
                 UACPI_PARSE_OP_TRACKED_PKGLEN,                                \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,             \
                 ##__VA_ARGS__,                                                \
...
#define UACPI_BUILD_TO_FROM_BCD(type, code)                                    \
    UACPI_OP(type##BCDOp, UACPI_EXT_OP(code), UACPI_OP_PROPERTY_TERM_ARG,      \
             {                                                                 \
                 UACPI_PARSE_OP_OPERAND,                                       \
                 UACPI_PARSE_OP_TARGET,                                        \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                            \
...
#define UACPI_ENUMERATE_EXT_OPCODES                                            \
    UACPI_OP(ReservedExtOp, UACPI_EXT_OP(0x00), 0,                             \
             {                                                                 \
                 UACPI_PARSE_OP_BAD_OPCODE,                                    \
             })                                                                \
    UACPI_OP(MutexOp, UACPI_EXT_OP(0x01), 0,                                   \
             {                                                                 \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,             \
                 UACPI_PARSE_OP_LOAD_IMM,                                      \
                 1,                                                            \
    ...
    UACPI_OP(EventOp, UACPI_EXT_OP(0x02), 0,                                   \
             {                                                                 \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,             \
                 UACPI_PARSE_OP_SKIP_WITH_WARN_IF_NULL,                        \
                 0,                                                            \
    ...
    UACPI_OP(CondRefOfOp, UACPI_EXT_OP(0x12), UACPI_OP_PROPERTY_TERM_ARG,      \
             {                                                                 \
                 UACPI_PARSE_OP_SUPERNAME_OR_UNRESOLVED,                       \
                 UACPI_PARSE_OP_TARGET,                                        \
                 UACPI_PARSE_OP_IF_NULL,                                       \
    ...
    UACPI_DO_BUILD_BUFFER_FIELD_OP(Create, UACPI_EXT_OP(0x13), 3,              \
                                   UACPI_PARSE_OP_OPERAND)                     \
    UACPI_OUT_OF_LINE_OP(                                                      \
        LoadTableOp, UACPI_EXT_OP(0x1F), uacpi_load_table_op_decode_ops,       \
    ...
    UACPI_OP(StallOp, UACPI_EXT_OP(0x21), 0,                                   \
             {                                                                 \
                 UACPI_PARSE_OP_OPERAND,                                       \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                \
             })                                                                \
    UACPI_OP(SleepOp, UACPI_EXT_OP(0x22), 0,                                   \
             {                                                                 \
                 UACPI_PARSE_OP_OPERAND,                                       \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                \
             })                                                                \
    UACPI_OP(AcquireOp, UACPI_EXT_OP(0x23), UACPI_OP_PROPERTY_TERM_ARG,        \
             {                                                                 \
                 UACPI_PARSE_OP_SUPERNAME,                                     \
                 UACPI_PARSE_OP_LOAD_IMM,                                      \
                 2,                                                            \
    ...
    UACPI_OP(SignalOp, UACPI_EXT_OP(0x24), 0,                                  \
             {                                                                 \
                 UACPI_PARSE_OP_SUPERNAME,                                     \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                \
             })                                                                \
    UACPI_OP(WaitOp, UACPI_EXT_OP(0x25), UACPI_OP_PROPERTY_TERM_ARG,           \
             {                                                                 \
                 UACPI_PARSE_OP_SUPERNAME,                                     \
                 UACPI_PARSE_OP_OPERAND,                                       \
                 UACPI_PARSE_OP_LOAD_TRUE_OBJECT,                              \
    ...
    UACPI_OP(ResetOp, UACPI_EXT_OP(0x26), 0,                                   \
             {                                                                 \
                 UACPI_PARSE_OP_SUPERNAME,                                     \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                \
             })                                                                \
    UACPI_OP(ReleaseOp, UACPI_EXT_OP(0x27), 0,                                 \
             {                                                                 \
                 UACPI_PARSE_OP_SUPERNAME,                                     \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                \
             })                                                                \
    ...
    UACPI_OP(UnloadOp, UACPI_EXT_OP(0x2A), 0,                                  \
             {                                                                 \
                 UACPI_PARSE_OP_SUPERNAME,                                     \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                \
             })                                                                \
    UACPI_OP(RevisionOp, UACPI_EXT_OP(0x30), UACPI_OP_PROPERTY_TERM_ARG,       \
             {                                                                 \
                 UACPI_PARSE_OP_LOAD_INLINE_IMM_AS_OBJECT,                     \
                 0x01,                                                         \
                 0x00,                                                         \
    ...
    UACPI_OP(DebugOp, UACPI_EXT_OP(0x31),                                      \
             UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_SUPERNAME |        \
    ...
    UACPI_OP(FatalOp, UACPI_EXT_OP(0x32), 0,                                   \
             {                                                                 \
                 UACPI_PARSE_OP_LOAD_IMM,                                      \
                 1,                                                            \
                 UACPI_PARSE_OP_LOAD_IMM,                                      \
    ...
    UACPI_OP(TimerOp, UACPI_EXT_OP(0x33), UACPI_OP_PROPERTY_TERM_ARG,          \
             {                                                                 \
                 UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                            \
                 UACPI_OBJECT_INTEGER,                                         \
                 UACPI_PARSE_OP_INVOKE_HANDLER,                                \
    ...
    UACPI_OP(OpRegionOp, UACPI_EXT_OP(0x80), 0,                                \
             {                                                                 \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,             \
                 UACPI_PARSE_OP_LOAD_IMM,                                      \
                 1,                                                            \
    ...
    UACPI_OUT_OF_LINE_OP(FieldOp, UACPI_EXT_OP(0x81),                          \
                         uacpi_field_op_decode_ops,                            \
                         UACPI_OP_PROPERTY_OUT_OF_LINE)                        \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(Device, 0x82, UACPI_OBJECT_DEVICE)       \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(                                         \
        Processor, 0x83, UACPI_OBJECT_PROCESSOR, UACPI_PARSE_OP_LOAD_IMM, 1,   \
        UACPI_PARSE_OP_LOAD_IMM, 4, UACPI_PARSE_OP_LOAD_IMM, 1)                \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(                                         \
        PowerRes, 0x84, UACPI_OBJECT_POWER_RESOURCE, UACPI_PARSE_OP_LOAD_IMM,  \
        1, UACPI_PARSE_OP_LOAD_IMM, 2)                                         \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(ThermalZone, 0x85,                       \
                                      UACPI_OBJECT_THERMAL_ZONE)               \
    UACPI_OUT_OF_LINE_OP(IndexFieldOp, UACPI_EXT_OP(0x86),                     \
                         uacpi_index_field_op_decode_ops,                      \
                         UACPI_OP_PROPERTY_OUT_OF_LINE)                        \
    UACPI_OUT_OF_LINE_OP(BankFieldOp, UACPI_EXT_OP(0x87),                      \
                         uacpi_bank_field_op_decode_ops,                       \
                         UACPI_OP_PROPERTY_OUT_OF_LINE)                        \
    UACPI_OP(DataRegionOp, UACPI_EXT_OP(0x88), 0,                              \
             {                                                                 \
                 UACPI_PARSE_OP_CREATE_NAMESTRING_OR_NULL_IF_LOAD,             \
                 UACPI_PARSE_OP_STRING,                                        \
                 UACPI_PARSE_OP_STRING,                                        \
...
#define UACPI_OUT_OF_LINE_OP(name, code, ...) UACPI_AML_OP_##name = code,
    UACPI_ENUMERATE_OPCODES UACPI_ENUMERATE_EXT_OPCODES
#undef UACPI_OP
