...
#define UACPI_ENUMERATE_OPCODES                                                                                                                                                                      \
    ...
    UACPI_OP(NotifyOp, 0x86, 0,                                                                                                                                                                      \
             {                                                                                                                                                                                       \
                 /* This is technically wrong according to spec but I was */ /* unable to find any examples of anything else after    */ /* inspecting about 500 AML dumps. Spec says this is a   */ \
                 /* SuperName that must evaluate to Device/ThermalZone or */ /* Processor,                                                                                                           \
                                                                                just                                                                                                                 \
                                                                                ignore                                                                                                               \
                                                                                for                                                                                                                  \
                                                                                now.                                                                                                                 \
