...
// 主机字节序到网络字节序（大端）
#define htobe16(x)                                                             \
    (BYTE_ORDER == LITTLE_ENDIAN ? __bswap_16(x) : __uint16_identity(x))
#define htobe32(x)                                                             \
    (BYTE_ORDER == LITTLE_ENDIAN ? __bswap_32(x) : __uint32_identity(x))
#define htobe64(x)                                                             \
    (BYTE_ORDER == LITTLE_ENDIAN ? __bswap_64(x) : __uint64_identity(x))

// 主机字节序到小端
#define htole16(x)                                                             \
    (BYTE_ORDER == BIG_ENDIAN ? __bswap_16(x) : __uint16_identity(x))
#define htole32(x)                                                             \
    (BYTE_ORDER == BIG_ENDIAN ? __bswap_32(x) : __uint32_identity(x))
#define htole64(x)                                                             \
    (BYTE_ORDER == BIG_ENDIAN ? __bswap_64(x) : __uint64_identity(x))
